...
const Wrap = ({ children }) => <div className="main">{children}</div>;
...
export default class Container extends React.Component {
    ...
    constructor(props) {
        ...
        this.SL = new StateList(initial, props.recorder);
        this.state = {
            ...this.SL.getState(),
            params
        };
    ...
    componentDidMount() {
        ...
        if (+params.simto) {
            simulate(this.SL, modules, components, +params.simto);
        }
    }
    ...
    push = (response, silent) => {
        ...
        const index = this.state.index;
            if(modules[index].module_name!=undefined){
            this.SL.push(response, modules[index].componentName,modules[index].module_name, silent);
            }
            else { 
                var a ='';
                this.SL.push(response, modules[index].componentName,a, silent);
                }
    ...
    render() {
        const { components, modules, state, wrapper } = this.props;
