...
var StateList = function () {
    function StateList(initial, recorder) {
        (0, _classCallCheck3.default)(this, StateList);

        this.initial = initial;
        this.record = recorder == null ? _record2.default : recorder;
        this.state = [{
            data: [],
            screenState: []
        }];
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
                                    ...
                                    _context.next = 4;
                                    return _this.record(endpoint, _this.initial, "initial");
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                _context2.next = 4;
                                return _this2.record(endpoint, _this2.state[_this2.index], _this2.index);
                            ...
                            case 6:
                                ...
                                console.error(_context2.t0, _context2.t0.stack);
