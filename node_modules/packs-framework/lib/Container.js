...
var Container = function (_React$Component) {
    ...
    function Container(props) {
        ...
        _this.push = function (response, silent) {
            ...
            _this.SL.push(response, modules[index].componentName, silent);
        };
        ...
        _this.SL = new _StateList2.default(initial, props.recorder);
    ...
    (0, _createClass3.default)(Container, [{
        ...
        value: function componentDidMount() {
            ...
            if (+params.simto) {
                (0, _simulate2.default)(this.SL, modules, components, +params.simto);
            }
        }
    }, {
        key: "render",
